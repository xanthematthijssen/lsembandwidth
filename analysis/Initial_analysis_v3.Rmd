...
### load bandwidths
```{r}
load("H:/lsembandwidth/output/bw/2020-04-29bw_int_imp1_5j.RData")
print(bw_int_imp1_5j %>% as.data.frame())

load("H:/lsembandwidth/output/bw/2020-04-29bw_int_imp1_1j.RData")
print(bw_int_imp1_1j %>% as.data.frame())
load("H:/lsembandwidth/output/bw/2020-04-29bw_int_imp1.RData")

print(bw_int_imp1 %>% as.data.frame())
```
