...
##### analysis ####
data <- fread("I:/Pi helm/Promovendi/Xanthe/data scriptie/2020-06-05simulation_mix.csv")
...
fwrite(models, file = "I:/Pi helm/Promovendi/Xanthe/data scriptie/2020-07-23CVs_mix_small3.csv")
