...
##### analysis ####
data <- fread("I:/Promovendi_Annette/Xanthe/data scriptie/2020-06-05simulation_norm.csv")
...
fwrite(models, file = "I:/Promovendi_Annette/Xanthe/data scriptie/2020-06-18CVs_norm_1_1000_small.csv")
