...
##### analysis ####
data <- fread("I:/Promovendi_Annette/Xanthe/data scriptie/2020-06-09simulation_increasing.csv")
...
fwrite(models, file = "I:/Promovendi_Annette/Xanthe/data scriptie/2020-06-16CVs_increasing_equal.csv")
