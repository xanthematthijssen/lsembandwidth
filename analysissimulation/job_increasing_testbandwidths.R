...
##### analysis ####
data <- fread("I:/Pi helm/Promovendi/Xanthe/data scriptie/2020-06-09simulation_increasing.csv")
...
fwrite(models, file = "I:/Pi helm/Promovendi/Xanthe/data scriptie/2020-07-23CVs_increasing_small3.csv")
