...
#numbers <- c(1:2)
##### analysis ####
data <- fread("I:/Pi helm/Promovendi/Xanthe/data scriptie/2020-08-10simulation_mix.csv")
...
fwrite(models, file = "I:/Pi helm/Promovendi/Xanthe/data scriptie/2020-08-10CVs_mix_25_3first.csv")
