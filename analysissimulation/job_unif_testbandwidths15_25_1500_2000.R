...
#numbers <- c(1:2)
##### analysis ####
data <- fread("I:/Pi helm/Promovendi/Xanthe/data scriptie/2020-08-10simulation_unif.csv")
...
fwrite(models, file = "I:/Pi helm/Promovendi/Xanthe/data scriptie/2020-08-10CVs_unif_15_25first.csv")
